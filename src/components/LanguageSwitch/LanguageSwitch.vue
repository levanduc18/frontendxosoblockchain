<template>
  <div
    class="nice-select h-10 pr-2 relative text-left z-50 leading-10 box-border select-none block cursor-pointer float-left text-sm font-normal w-12"
    :class="{
    ...
    @click="handleOpen"
  >
    <span class="current text-sm ml-2 mr-1">{{ currentLanguage }}</span>
    <ul class="list">
      <li class="option" @click="handleChangeLanguage('en')">en</li>
      <li class="option" @click="handleChangeLanguage('fr')">fr</li>
